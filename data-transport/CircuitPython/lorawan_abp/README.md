...
* Get a [TTN account](https://www.thethingsnetwork.org/), open the [console](https://console.thethingsnetwork.org/), create an app, add a device, change settings to *ABP* and uncheck *Frame Counter Checks*.
