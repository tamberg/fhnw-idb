# Publish Data using Wi-Fi and the MQTT API
...
* Copy the content of [wifi_mqtt.py](wifi_address.py) to _code.py_ on the _CIRCUITPY_ drive.
* Update your WIFI and ThingSpeak in _code.py_ settings.
